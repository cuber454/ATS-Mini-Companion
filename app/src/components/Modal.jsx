  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm">
      <div
        ...
        className="bg-icom-panel rounded-lg border-2 border-icom-accent shadow-2xl max-w-md w-full animate-fadeIn"
      >
        {/* Header */}
        <div className="bg-gradient-to-r from-icom-display to-icom-bg p-4 border-b border-icom-accent/30 rounded-t-lg">
          <h3 id="modal-title" className="text-lg font-digital text-icom-accent">{title}</h3>
        </div>
